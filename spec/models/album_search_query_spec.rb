...
describe AlbumSearchQuery do
  ...
  it "should set all the attributes in a complete query using what's left for the title" do
    wsq = AlbumSearchQuery.new('date_released:2011-09-01 This is a search " query with no keyworkds" label:"Production Pierre F." oid:4e81265241c25e24b6000001 reference_code:"425345lkj-1234"')
    wsq[:title].should eql('This is a search " query with no keyworkds"')
