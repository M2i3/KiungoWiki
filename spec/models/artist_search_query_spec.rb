...
describe ArtistWikiLink::SearchQuery do
  it "should all go under the title when doing a basic query" do
    wsq = ArtistWikiLink::SearchQuery.new('This is a search " query with no keyworkds"')
  ...
  it "should set all the attributes in a complete query using what's left for the title" do
    wsq = ArtistWikiLink::SearchQuery.new('birth_date:1977-02-26 birth_location:"Sorel, QC, Canada" death_date:2075-03-17 death_location:"3rd satellite of saturn" Francois "Fantastic" Gaudreault oid:4e81265241c25e24b6340001')
