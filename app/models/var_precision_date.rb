require 'date'
    ...
    # 
    # An VarPrecisionDate is a Range of Date objects. The incomplete date
    ...
    class VarPrecisionDate < ::Range
      ...
      # Compare two VarPrecisionDate objects for equality.
      # 
      # You can compare an VarPrecisionDate with another VarPrecisionDate, with
      # a Range of Date objects or directly with a Date. The following examples
      # all return true:
      # 
      #  VarPrecisionDate.new('1969-01-05').eql?( VarPrecisionDate.new('1969-01-05') )
      #  VarPrecisionDate.new('1969-01-05').eql?( Date.civil(1969, 1, 5) )
      #  VarPrecisionDate.new('1969-01').eql?( Date.civil(1969, 1)..Date.civil(1969, 1, 31) )
      #  VarPrecisionDate.new('1969-01').eql?( Date.civil(1969, 1)...Date.civil(1969, 2, 1) )
      #  
      # Please note that comparing an VarPrecisionDate with something else than a
      # VarPrecisionDate is normally not symmetric.
      def eql?(b)
        if b.kind_of? ::Range
      ...
      # Returns true if b is completely included in this VarPrecisionDate. Unlike
